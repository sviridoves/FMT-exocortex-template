...
Пример: «⚠️ Эволюционируемость, Современность, Безопасность (3 шт.) | ✅ Масштабируемость, Обучаемость, Генеративность, Скорость (5 шт.)».
→ Вывод: сработало (≥5⚠️ и 0✅) / не сработало.
...
- Ни одно не сработало → **Решение проходит вето-фильтр** → шаг 5.

## Шаг 5. Доменные расширения (L2)

> L2 = информативный (не блокирующий до обкатки). Полное описание: DP.M.005 §9.

**5a. Определи триггеры:**
...
| Оценка/измерение (ЦД, метрики, stage, score) | **Воспроизводимость** (L2.5) |
...
**5b. Оцени сработавшие L2 (тоже ✅/⚠️/❌, без числовой шкалы):**

Чеклисты: DP.ARCH.001 §5.8–5.15. Формат:
