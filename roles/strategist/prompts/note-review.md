...
Источник сценария: /home/sviridov/IWE/PACK-digital-platform/pack/digital-platform/02-domain-entities/DP.ROLE.012-strategist/scenarios/scheduled/note-review.md

## Контекст

- **Заметки:** /home/sviridov/IWE/DS-strategy/inbox/[fleeting-notes.md](https://github.com/sviridoves/DS-strategy/blob/main/inbox/fleeting-notes.md)
- **НЭП:** /home/sviridov/IWE/DS-strategy/docs/Dissatisfactions.md
...
- Сверь заметку с коммитами за сегодня (`git log --since="00:00" --all --oneline` по всем /home/sviridov/IWE/ репо) и текущим WeekPlan
