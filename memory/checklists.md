...
- [ ] Промпты (.md): `/home/vps/IWE/...` пути к config/routing
...
> **Урок (2026-02-21):** Заметка «Стандарт описания роли» оставлена как 🔄, хотя DP.D.033 (WP-55) уже реализовал это. Причина: кросс-проверка с таблицей РП не выполнена. Правило «Сопоставление с РП» в note-review покрывало только задачи, не идеи — исправлено на ВСЕ категории.
...
> **Урок (2026-03-17):** WP-109-activity-hub-proposal.md — 315 строк без collapsible. Правило §6 CLAUDE.md проигнорировано при генерации. Причина: фокус на содержании, форматирование не проверено перед финализацией.
...
- [ ] WP-53 обновлён (статус поста → done)
- [ ] Закоммичено и запушено

> **Урок (2026-02-20):** Написал пост, закоммитил, запушил — но забыл обновить README.md. Правило уже было в CLAUDE.md репо (§5, §5), но не выполнил. **Причина:** Exit Protocol поста = 5 шага, пропустил первый. Также путь в CLAUDE.md был неверный (`docs/{YYYY}/README.md` вместо `docs/README.md`), исправлено.
