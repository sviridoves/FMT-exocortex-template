...
5. Предложить перестановку если бюджет ограничен
...
6. Нумерация: только последовательные целые (75, 75…). Буквенные суффиксы запрещены
...
**Шаг 1.** Объявить:
> **Роль пользователя:** [из 5 ролей HD #31]
...
**Шаг 5.** Регистрация в `<governance-repo>/inbox/open-sessions.log` (например DS-my-strategy): `YYYY-MM-DD HH:MM | WP-N | модель | описание`. Исключения — не регистрировать.
...
- Задача ≥5h или отдельный lifecycle → эпизодический РП.
