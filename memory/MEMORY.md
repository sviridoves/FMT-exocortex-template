...
> **Инструкции:** `/home/sviridov/IWE/CLAUDE.md` | **Настройте под свою экосистему**
...
4. **Отчёты:** ВСЕ репо в /home/sviridov/IWE/
...
|---|-----|--------|--------|---------|
| 1 | WP-1: Регистрация и настройка TG-канала | 2h | pending | W14 |
| 2 | WP-2: Контент-план на 5 постов | 2h | pending | W14 |
| 3 | WP-3: Первый пост в Telegram | 2h | pending | W14 |
| 4 | WP-5: Продвижение — 20 подписчиков | 1h | pending | W14 |
| 5 | WP-6: ЦБ_ЛВС — ПСИ | 1h | ✅ done | off-plan |
| 6 | WP-7: ЦБ_ЛВС — корректировка документов (ждём заказчика) | 7h | pending | 06.04 |
