...
| Новый инструмент/агент/система | **IntegrationGate:** тип, контур (L2/L3/L5), роли, продукты, процессы |
...
Рабочая директория: `/home/vps/IWE/` (не из sub-директорий). `/home/vps/IWE/memory/` = симлинк на auto-memory.
=======
...
5. Обновить STAGING.md: статус → `promoted`
...
<<<<<<< /tmp/tmp.rpG0ZpZhsR/claude-merge.md
- `/home/vps/IWE/` — рабочая директория
=======
- `/home/vps/IWE/` — рабочая директория
>>>>>>> /tmp/tmp.rpG0ZpZhsR/files/CLAUDE.md
...
**Синхронизация REGISTRY→производные (Staging S-15):** при переименовании РП → обновить одновременно REGISTRY.md + MEMORY.md + WeekPlan + DayPlan (если активен) + WP-context file.
